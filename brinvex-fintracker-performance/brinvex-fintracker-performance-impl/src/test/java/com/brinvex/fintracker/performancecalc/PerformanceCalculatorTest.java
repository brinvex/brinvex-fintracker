...
import static com.brinvex.fintracker.performancecalc.api.model.RateOfReturnCalcMethod.TwrCalcMethod.LINKED_MODIFIED_DIETZ;
...
public class PerformanceCalculatorTest {
    ...
    void perfCalc2() {
        ...
        assertEquals("0.000000", calculator.calculateReturn(mwrReq1.copy().build()).toPlainString());
        assertEquals("0.000000", calculator.calculateReturn(mwrReq1.copy().calcMethod(TRUE_TWR).build()).toPlainString());
    }
    ...
    void perfCalc3() {
        ...
        assertEquals("-1.000000", calculator.calculateReturn(mwrReq1.copy().build()).toPlainString());
        assertEquals("-1.000000", calculator.calculateReturn(mwrReq1.copy().calcMethod(TRUE_TWR).build()).toPlainString());
    }
    ...
    void perfCalc4_bankruptcy() {
        ...
        assertEquals("-1.000000", calculator.calculateReturn(req.copy().calcMethod(MODIFIED_DIETZ).build()).toPlainString());
        assertEquals("-1.000000", calculator.calculateReturn(req.copy().calcMethod(TRUE_TWR).build()).toPlainString());
    }
    ...
    void perfCalc7() {
        ...
        assertEquals("0.020000", calculator.calculateReturn(req.copy()
                .calcMethod(TRUE_TWR).annualization(DO_NOT_ANNUALIZE).build()).toPlainString());
        assertEquals("0.009950", calculator.calculateReturn(req.copy()
                .calcMethod(TRUE_TWR).annualization(ANNUALIZE).build()).toPlainString());
        assertEquals("0.020000", calculator.calculateReturn(req.copy()
                .calcMethod(MODIFIED_DIETZ).annualization(DO_NOT_ANNUALIZE).build()).toPlainString());
        assertEquals("0.009950", calculator.calculateReturn(req.copy()
                .calcMethod(MODIFIED_DIETZ).annualization(ANNUALIZE).build()).toPlainString());
    }
    ...
    void perfCalc10() {
        PerfCalcRequestBuilder req = PerfCalcRequest.builder()
                .calcMethod(LINKED_MODIFIED_DIETZ)
                .startDateIncl(parse("2021-01-01"))
                ...
                .flowTiming(BEGINNING_OF_DAY)
                .annualization(DO_NOT_ANNUALIZE);
        assertEquals("0.020000", calculator.calculateReturn(req.copy().build()).toPlainString());
    }
    ...
    void perfCalc12() {
        PerfCalcRequestBuilder req = PerfCalcRequest.builder()
                ...
                .flowTiming(BEGINNING_OF_DAY)
                .annualization(DO_NOT_ANNUALIZE);
        assertEquals("0.010000", calculator.calculateReturn(req.copy().build()).toPlainString());
    }
