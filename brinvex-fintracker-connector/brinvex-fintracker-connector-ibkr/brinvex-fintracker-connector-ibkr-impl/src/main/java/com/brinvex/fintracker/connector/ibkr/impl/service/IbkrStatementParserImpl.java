...
import com.brinvex.fintracker.connector.ibkr.api.model.statement.FlexStatementType;
...
import com.brinvex.fintracker.connector.ibkr.impl.builder.ActivityStatementBuilder;
import com.brinvex.fintracker.connector.ibkr.impl.builder.CashTransactionBuilder;
import com.brinvex.fintracker.connector.ibkr.impl.builder.CorporateActionBuilder;
import com.brinvex.fintracker.connector.ibkr.impl.builder.EquitySummaryBuilder;
            ...
            while (reader.hasNext()) {
                ...
                switch (e.getName().getLocalPart()) {
                    ...
                    case "Trade" -> trades.add(new TradeBuilder()
                            .currency(getAttrValue(e, TradeQN.currency))
                            ...
                            .ibCommissionCurrency(getAttrValue(e, TradeQN.ibCommissionCurrency))
                    ...
                    case "CashTransaction" -> cashTransactions.add(new CashTransactionBuilder()
                            .currency(getAttrValue(e, CashTransactionQN.currency))
                    ...
                    case "CorporateAction" -> corporateActions.add(new CorporateActionBuilder()
                            ...
                            .currency(getAttrValue(e, CorporateActionQN.currency))
                    ...
                    case "EquitySummaryByReportDateInBase" -> equitySummaries.add(new EquitySummaryBuilder()
                            .currency(getAttrValue(e, EquitySummaryQN.currency))
            ...
            while (reader.hasNext()) {
                ...
                switch (e.getName().getLocalPart()) {
                    ...
                    case "TradeConfirm" -> tradeConfirms.add(new TradeConfirmBuilder()
                            .currency(getAttrValue(e, TradeConfirmQN.currency))
                            ...
                            .commissionCurrency(getAttrValue(e, TradeConfirmQN.commissionCurrency))
